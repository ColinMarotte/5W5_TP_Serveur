        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QtyManaPerTurn = table.Column<int>(type: "INTEGER", nullable: false),
                    NbDecksMax = table.Column<int>(type: "INTEGER", nullable: false),
                    NbCardsMaxInDeck = table.Column<int>(type: "INTEGER", nullable: false),
                    ArgentRecuGagnant = table.Column<int>(type: "INTEGER", nullable: false),
                    ArgentRecuPerdant = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardPowers", x => x.CardPowerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnedCardId1 = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeckOwnedCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeckOwnedCards_Decks_DeckId",
                        column: x => x.DeckId,
                        principalTable: "Decks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeckOwnedCards_Decks_DeckId1",
                        column: x => x.DeckId1,
                        principalTable: "Decks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeckOwnedCards_OwnedCards_OwnedCardId",
                        column: x => x.OwnedCardId,
                        principalTable: "OwnedCards",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeckOwnedCards_OwnedCards_OwnedCardId1",
                        column: x => x.OwnedCardId1,
                        principalTable: "OwnedCards",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "11111111-1111-1111-1111-111111111111", 0, "ba3265d1-1bf4-4687-ba39-bce0bc7ab06a", "admin@admin.com", true, true, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAIAAYagAAAAEOikfX46v77DXL9iuByXHFkeznpFjW2R8t3Pe/d6zic6BGH+sry+bymmPlNG16VPQg==", null, false, "f04f5bf2-1b8d-4769-9ce5-5ca8c0ad27d4", false, "admin@admin.com" },
                    { "User1Id", 0, "17895a5e-1a2d-4df2-bb4c-9719d3063fa4", null, false, false, null, null, null, null, null, false, "db11c21e-6540-403e-8a4c-8e95e3fa4ae7", false, null },
                    { "User2Id", 0, "f5785158-bd55-4c43-8556-9ef006ac2168", null, false, false, null, null, null, null, null, false, "de2c56a9-2154-4b44-a8b8-a7cbe4be60fc", false, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeckOwnedCards_DeckId",
                table: "DeckOwnedCards",
                column: "DeckId");

            migrationBuilder.CreateIndex(
                name: "IX_DeckOwnedCards_DeckId1",
                table: "DeckOwnedCards",
                column: "DeckId1");

            migrationBuilder.CreateIndex(
                name: "IX_DeckOwnedCards_OwnedCardId",
                table: "DeckOwnedCards",
                column: "OwnedCardId");

            migrationBuilder.CreateIndex(
                name: "IX_DeckOwnedCards_OwnedCardId1",
                table: "DeckOwnedCards",
                column: "OwnedCardId1");
